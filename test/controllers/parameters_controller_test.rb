...
class ParametersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parameter" do
    assert_difference('Parameter.count') do
      post parameters_url, params: { parameter: { exposure_id: @parameter.exposure_id, name: @parameter.name, required: @parameter.required } }
    end
  ...
  test "should update parameter" do
    patch parameter_url(@parameter), params: { parameter: { exposure_id: @parameter.exposure_id, name: @parameter.name, required: @parameter.required } }
