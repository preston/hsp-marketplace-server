...
json.extract! identity_provider, :id, :name, :issuer
...
if can? :update, identity_provider
	json.extract! identity_provider, :client_id, :client_secret, :alternate_client_id, :scopes, :enabled_at, :configuration, :public_keys, :created_at, :updated_at
end
