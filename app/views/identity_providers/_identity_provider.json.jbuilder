json.extract! identity_provider, :id, :name, :issuer, :enabled_at, :client_id, :client_secret, :alternate_client_id, :scopes, :configuration, :public_keys, :created_at, :updated_at
